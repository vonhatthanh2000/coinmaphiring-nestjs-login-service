...
export class AddUser1681490006361 implements MigrationInterface {
    name = 'AddUser1681490006361'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_status_enum" AS ENUM('inactive', 'active', 'deactive', 'verify_email')`);
